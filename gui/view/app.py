...
class PVTcalcApp(
    ...
    def __init__(self, state: AppState, session: SessionState):
        ...
        # Модели, отмеченные в выдаче поиска для межмодельного Compare.
        self._search_selected_model_ids: set[str] = set()
        ...
        self._lab_catalog_active_cell: tuple[int, int] | None = None
        self._lab_catalog_cell_ids: dict[tuple[int, int], int] = {}
        ...
        self._lab_catalog_edit_input_theme_id: int | None = None
